...
export interface EthereumDIDRegistryInterface extends utils.Interface {
  functions: {
    ...
    "getDIDDocumentCID(address)": FunctionFragment;
    "getProfileCID(address)": FunctionFragment;
    ...
    "setDIDDocumentCID(address,string)": FunctionFragment;
    "setProfileCID(address,string)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getDIDDocumentCID",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "getProfileCID",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setDIDDocumentCID",
    values: [PromiseOrValue<string>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "setProfileCID",
    values: [PromiseOrValue<string>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "DIDDocumentCIDUpdated(address,string)": EventFragment;
    "DIDOwnerChanged(address,address,uint256)": EventFragment;
    "ProfileCIDUpdated(address,string)": EventFragment;
  };
  ...
  getEvent(nameOrSignatureOrTopic: "DIDDocumentCIDUpdated"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "DIDOwnerChanged"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "ProfileCIDUpdated"): EventFragment;
}
...
export interface DIDDocumentCIDUpdatedEventObject {
  identity: string;
  cid: string;
}
export type DIDDocumentCIDUpdatedEvent = TypedEvent<
  [string, string],
  DIDDocumentCIDUpdatedEventObject
>;

export type DIDDocumentCIDUpdatedEventFilter =
  TypedEventFilter<DIDDocumentCIDUpdatedEvent>;
...
export interface ProfileCIDUpdatedEventObject {
  identity: string;
  cid: string;
}
export type ProfileCIDUpdatedEvent = TypedEvent<
  [string, string],
  ProfileCIDUpdatedEventObject
>;

export type ProfileCIDUpdatedEventFilter =
  TypedEventFilter<ProfileCIDUpdatedEvent>;
...
export interface EthereumDIDRegistry extends BaseContract {
  ...
  filters: {
    ...
    "DIDDocumentCIDUpdated(address,string)"(
      identity?: PromiseOrValue<string> | null,
      cid?: null
    ): DIDDocumentCIDUpdatedEventFilter;
    ...
    "ProfileCIDUpdated(address,string)"(
      identity?: PromiseOrValue<string> | null,
      cid?: null
    ): ProfileCIDUpdatedEventFilter;
    ProfileCIDUpdated(
      identity?: PromiseOrValue<string> | null,
      cid?: null
    ): ProfileCIDUpdatedEventFilter;
